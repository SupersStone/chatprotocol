...
type AttributeListResp struct {
	...
	Users []*sdkws.Attribute `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`
}
...
func (x *AttributeListResp) GetUsers() []*sdkws.Attribute {
	if x != nil {
		return x.Users
	}
	return nil
...
var file_chat_chat_proto_rawDesc = []byte{
	...
	0x49, 0x44, 0x73, 0x22, 0x42, 0x0a, 0x11, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65,
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2d, 0x0a, 0x05, 0x75, 0x73, 0x65, 0x72,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x69, 0x6d,
	0x2e, 0x73, 0x64, 0x6b, 0x77, 0x73, 0x2e, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65,
	0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x32, 0xf5, 0x14, 0x0a, 0x04, 0x63, 0x68, 0x61, 0x74,
	...
	0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x42,
...
var file_chat_chat_proto_goTypes = []any{
	...
	(*AttributeListResp)(nil),           // 69: openim.chat.AttributeListResp
	...
	(*common.UserPublicInfo)(nil),       // 76: openim.chat.common.UserPublicInfo
	(*sdkws.RequestPagination)(nil),     // 77: openim.sdkws.RequestPagination
	(*common.UserFullInfo)(nil),         // 78: openim.chat.common.UserFullInfo
	(*common.ContactFullInfo)(nil),      // 79: openim.chat.common.ContactFullInfo
	(*sdkws.Attribute)(nil),             // 80: openim.sdkws.Attribute
}
var file_chat_chat_proto_depIdxs = []int32{
	...
	73, // 14: openim.chat.UpdateUserInfoReq.name:type_name -> openim.protobuf.StringValue
	73, // 15: openim.chat.UpdateUserInfoReq.surname:type_name -> openim.protobuf.StringValue
	76, // 16: openim.chat.FindUserPublicInfoResp.users:type_name -> openim.chat.common.UserPublicInfo
	77, // 17: openim.chat.SearchUserPublicInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	76, // 18: openim.chat.SearchUserPublicInfoResp.users:type_name -> openim.chat.common.UserPublicInfo
	78, // 19: openim.chat.FindUserFullInfoResp.users:type_name -> openim.chat.common.UserFullInfo
	...
	70, // 22: openim.chat.FindUserAccountResp.userAccountMap:type_name -> openim.chat.FindUserAccountResp.UserAccountMapEntry
	71, // 23: openim.chat.FindAccountUserResp.accountUserMap:type_name -> openim.chat.FindAccountUserResp.AccountUserMapEntry
	76, // 24: openim.chat.SignalRecord.inviterUserList:type_name -> openim.chat.common.UserPublicInfo
	77, // 25: openim.chat.SearchUserFullInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	78, // 26: openim.chat.SearchUserFullInfoResp.users:type_name -> openim.chat.common.UserFullInfo
	72, // 27: openim.chat.UserLoginCountResp.count:type_name -> openim.chat.UserLoginCountResp.CountEntry
	77, // 28: openim.chat.SearchUserInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	78, // 29: openim.chat.SearchUserInfoResp.users:type_name -> openim.chat.common.UserFullInfo
	14, // 30: openim.chat.CheckUserExistReq.user:type_name -> openim.chat.RegisterUserInfo
	79, // 31: openim.chat.GetContactListResp.users:type_name -> openim.chat.common.ContactFullInfo
	...
	80, // 34: openim.chat.AttributeListResp.users:type_name -> openim.sdkws.Attribute
	...
	69, // 96: openim.chat.chat.AttributeList:output_type -> openim.chat.AttributeListResp
