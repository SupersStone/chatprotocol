...
var file_chat_chat_proto_rawDesc = []byte{
	...
	0x49, 0x44, 0x73, 0x22, 0xab, 0x07, 0x0a, 0x09, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74,
	...
	0x73, 0x22, 0x41, 0x0a, 0x11, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x4c, 0x69,
	0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2c, 0x0a, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x69, 0x6d, 0x2e, 0x63,
	0x68, 0x61, 0x74, 0x2e, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x52, 0x05, 0x75,
	0x73, 0x65, 0x72, 0x73, 0x32, 0xf5, 0x14, 0x0a, 0x04, 0x63, 0x68, 0x61, 0x74, 0x12, 0x51, 0x0a,
	...
	0x69, 0x6e, 0x65, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x42, 0x2d, 0x5a, 0x2b,
	...
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_chat_chat_proto_msgTypes = make([]protoimpl.MessageInfo, 74)
var file_chat_chat_proto_goTypes = []any{
	...
	nil,                                 // 71: openim.chat.FindUserAccountResp.UserAccountMapEntry
	nil,                                 // 72: openim.chat.FindAccountUserResp.AccountUserMapEntry
	nil,                                 // 73: openim.chat.UserLoginCountResp.CountEntry
	...
	(*common.ContactFullInfo)(nil),      // 80: openim.chat.common.ContactFullInfo
}
var file_chat_chat_proto_depIdxs = []int32{
	74, // 0: openim.chat.UpdateUserInfoReq.account:type_name -> openim.protobuf.StringValue
	74, // 1: openim.chat.UpdateUserInfoReq.phoneNumber:type_name -> openim.protobuf.StringValue
	74, // 2: openim.chat.UpdateUserInfoReq.areaCode:type_name -> openim.protobuf.StringValue
	74, // 3: openim.chat.UpdateUserInfoReq.email:type_name -> openim.protobuf.StringValue
	74, // 4: openim.chat.UpdateUserInfoReq.nickname:type_name -> openim.protobuf.StringValue
	74, // 5: openim.chat.UpdateUserInfoReq.faceURL:type_name -> openim.protobuf.StringValue
	75, // 6: openim.chat.UpdateUserInfoReq.gender:type_name -> openim.protobuf.Int32Value
	75, // 7: openim.chat.UpdateUserInfoReq.level:type_name -> openim.protobuf.Int32Value
	76, // 8: openim.chat.UpdateUserInfoReq.birth:type_name -> openim.protobuf.Int64Value
	75, // 9: openim.chat.UpdateUserInfoReq.allowAddFriend:type_name -> openim.protobuf.Int32Value
	75, // 10: openim.chat.UpdateUserInfoReq.allowBeep:type_name -> openim.protobuf.Int32Value
	75, // 11: openim.chat.UpdateUserInfoReq.allowVibration:type_name -> openim.protobuf.Int32Value
	75, // 12: openim.chat.UpdateUserInfoReq.globalRecvMsgOpt:type_name -> openim.protobuf.Int32Value
	75, // 13: openim.chat.UpdateUserInfoReq.RegisterType:type_name -> openim.protobuf.Int32Value
	74, // 14: openim.chat.UpdateUserInfoReq.name:type_name -> openim.protobuf.StringValue
	74, // 15: openim.chat.UpdateUserInfoReq.surname:type_name -> openim.protobuf.StringValue
	77, // 16: openim.chat.FindUserPublicInfoResp.users:type_name -> openim.chat.common.UserPublicInfo
	78, // 17: openim.chat.SearchUserPublicInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	77, // 18: openim.chat.SearchUserPublicInfoResp.users:type_name -> openim.chat.common.UserPublicInfo
	79, // 19: openim.chat.FindUserFullInfoResp.users:type_name -> openim.chat.common.UserFullInfo
	...
	71, // 22: openim.chat.FindUserAccountResp.userAccountMap:type_name -> openim.chat.FindUserAccountResp.UserAccountMapEntry
	72, // 23: openim.chat.FindAccountUserResp.accountUserMap:type_name -> openim.chat.FindAccountUserResp.AccountUserMapEntry
	77, // 24: openim.chat.SignalRecord.inviterUserList:type_name -> openim.chat.common.UserPublicInfo
	78, // 25: openim.chat.SearchUserFullInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	79, // 26: openim.chat.SearchUserFullInfoResp.users:type_name -> openim.chat.common.UserFullInfo
	73, // 27: openim.chat.UserLoginCountResp.count:type_name -> openim.chat.UserLoginCountResp.CountEntry
	78, // 28: openim.chat.SearchUserInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	79, // 29: openim.chat.SearchUserInfoResp.users:type_name -> openim.chat.common.UserFullInfo
	14, // 30: openim.chat.CheckUserExistReq.user:type_name -> openim.chat.RegisterUserInfo
	80, // 31: openim.chat.GetContactListResp.users:type_name -> openim.chat.common.ContactFullInfo
	...
	1,  // 35: openim.chat.chat.UpdateUserInfo:input_type -> openim.chat.UpdateUserInfoReq
	17, // 36: openim.chat.chat.AddUserAccount:input_type -> openim.chat.AddUserAccountReq
	6,  // 37: openim.chat.chat.SearchUserPublicInfo:input_type -> openim.chat.SearchUserPublicInfoReq
	4,  // 38: openim.chat.chat.FindUserPublicInfo:input_type -> openim.chat.FindUserPublicInfoReq
	31, // 39: openim.chat.chat.SearchUserFullInfo:input_type -> openim.chat.SearchUserFullInfoReq
	8,  // 40: openim.chat.chat.FindUserFullInfo:input_type -> openim.chat.FindUserFullInfoReq
	10, // 41: openim.chat.chat.SendVerifyCode:input_type -> openim.chat.SendVerifyCodeReq
	12, // 42: openim.chat.chat.VerifyCode:input_type -> openim.chat.VerifyCodeReq
	15, // 43: openim.chat.chat.RegisterUser:input_type -> openim.chat.RegisterUserReq
	19, // 44: openim.chat.chat.Login:input_type -> openim.chat.LoginReq
	20, // 45: openim.chat.chat.ResetPassword:input_type -> openim.chat.ResetPasswordReq
	22, // 46: openim.chat.chat.ChangePassword:input_type -> openim.chat.ChangePasswordReq
	40, // 47: openim.chat.chat.CheckUserExist:input_type -> openim.chat.CheckUserExistReq
	42, // 48: openim.chat.chat.DelUserAccount:input_type -> openim.chat.DelUserAccountReq
	24, // 49: openim.chat.chat.FindUserAccount:input_type -> openim.chat.FindUserAccountReq
	26, // 50: openim.chat.chat.FindAccountUser:input_type -> openim.chat.FindAccountUserReq
	29, // 51: openim.chat.chat.OpenIMCallback:input_type -> openim.chat.OpenIMCallbackReq
	33, // 52: openim.chat.chat.UserLoginCount:input_type -> openim.chat.UserLoginCountReq
	36, // 53: openim.chat.chat.SearchUserInfo:input_type -> openim.chat.SearchUserInfoReq
	38, // 54: openim.chat.chat.GetTokenForVideoMeeting:input_type -> openim.chat.GetTokenForVideoMeetingReq
	44, // 55: openim.chat.chat.SetAllowRegister:input_type -> openim.chat.SetAllowRegisterReq
	46, // 56: openim.chat.chat.GetAllowRegister:input_type -> openim.chat.GetAllowRegisterReq
	48, // 57: openim.chat.chat.GetContactList:input_type -> openim.chat.GetContactListReq
	50, // 58: openim.chat.chat.CreateContact:input_type -> openim.chat.CreateContactReq
	52, // 59: openim.chat.chat.DelContact:input_type -> openim.chat.DelContactReq
	54, // 60: openim.chat.chat.IsContact:input_type -> openim.chat.IsContactReq
	56, // 61: openim.chat.chat.BlockContact:input_type -> openim.chat.BlockContactReq
	58, // 62: openim.chat.chat.CancelBlock:input_type -> openim.chat.CancelBlockReq
	60, // 63: openim.chat.chat.UpdateContact:input_type -> openim.chat.UpdateContactReq
	68, // 64: openim.chat.chat.AttributeList:input_type -> openim.chat.AttributeListReq
	62, // 65: openim.chat.chat.GetAllOnlineUsers:input_type -> openim.chat.GetAllOnlineUsersReq
	65, // 66: openim.chat.chat.GetAllOfflineUsers:input_type -> openim.chat.GetAllOfflineUsersReq
	2,  // 67: openim.chat.chat.UpdateUserInfo:output_type -> openim.chat.UpdateUserInfoResp
	18, // 68: openim.chat.chat.AddUserAccount:output_type -> openim.chat.AddUserAccountResp
	7,  // 69: openim.chat.chat.SearchUserPublicInfo:output_type -> openim.chat.SearchUserPublicInfoResp
	5,  // 70: openim.chat.chat.FindUserPublicInfo:output_type -> openim.chat.FindUserPublicInfoResp
	32, // 71: openim.chat.chat.SearchUserFullInfo:output_type -> openim.chat.SearchUserFullInfoResp
	9,  // 72: openim.chat.chat.FindUserFullInfo:output_type -> openim.chat.FindUserFullInfoResp
	11, // 73: openim.chat.chat.SendVerifyCode:output_type -> openim.chat.SendVerifyCodeResp
	13, // 74: openim.chat.chat.VerifyCode:output_type -> openim.chat.VerifyCodeResp
	16, // 75: openim.chat.chat.RegisterUser:output_type -> openim.chat.RegisterUserResp
	35, // 76: openim.chat.chat.Login:output_type -> openim.chat.LoginResp
	21, // 77: openim.chat.chat.ResetPassword:output_type -> openim.chat.ResetPasswordResp
	23, // 78: openim.chat.chat.ChangePassword:output_type -> openim.chat.ChangePasswordResp
	41, // 79: openim.chat.chat.CheckUserExist:output_type -> openim.chat.CheckUserExistResp
	43, // 80: openim.chat.chat.DelUserAccount:output_type -> openim.chat.DelUserAccountResp
	25, // 81: openim.chat.chat.FindUserAccount:output_type -> openim.chat.FindUserAccountResp
	27, // 82: openim.chat.chat.FindAccountUser:output_type -> openim.chat.FindAccountUserResp
	30, // 83: openim.chat.chat.OpenIMCallback:output_type -> openim.chat.OpenIMCallbackResp
	34, // 84: openim.chat.chat.UserLoginCount:output_type -> openim.chat.UserLoginCountResp
	37, // 85: openim.chat.chat.SearchUserInfo:output_type -> openim.chat.SearchUserInfoResp
	39, // 86: openim.chat.chat.GetTokenForVideoMeeting:output_type -> openim.chat.GetTokenForVideoMeetingResp
	45, // 87: openim.chat.chat.SetAllowRegister:output_type -> openim.chat.SetAllowRegisterResp
	47, // 88: openim.chat.chat.GetAllowRegister:output_type -> openim.chat.GetAllowRegisterResp
	49, // 89: openim.chat.chat.GetContactList:output_type -> openim.chat.GetContactListResp
	51, // 90: openim.chat.chat.CreateContact:output_type -> openim.chat.CreateContactResp
	53, // 91: openim.chat.chat.DelContact:output_type -> openim.chat.DelContactResp
	55, // 92: openim.chat.chat.IsContact:output_type -> openim.chat.IsContactResp
	57, // 93: openim.chat.chat.BlockContact:output_type -> openim.chat.BlockContactResp
	59, // 94: openim.chat.chat.CancelBlock:output_type -> openim.chat.CancelBlockResp
	61, // 95: openim.chat.chat.UpdateContact:output_type -> openim.chat.UpdateContactResp
	70, // 96: openim.chat.chat.AttributeList:output_type -> openim.chat.AttributeListResp
	64, // 97: openim.chat.chat.GetAllOnlineUsers:output_type -> openim.chat.GetAllOnlineUsersResp
	67, // 98: openim.chat.chat.GetAllOfflineUsers:output_type -> openim.chat.GetAllOfflineUsersResp
